...
function objectClassDataToFields(object) {
    ...
    if(object.position) fields.push({name: "Position", value: object.position, inline: true});
    if(object.type){
    ...
    if(object.color) fields.push({name: "Color", value: object.color, inline: true});
    ...
    if(object.members) fields.push({name: "Members", value: object.members.cache.size, inline: true});
    ...
    if(object.toString) fields.push({name: typeof object, value: object.toString(), inline: true});
